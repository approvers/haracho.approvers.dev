...
const CommandArg = ({ name, about, versionAvailableFrom, defaultValue }: CommandArg) => (
  <>
    <code>{name}</code>
    {': '}
    {about}
...
export const buildCommandFormat = (commandName: string, args?: readonly CommandArg[]): string => {
...
export const CommandArgs = ({ versionAvailableFrom, commandName, args }: CommandArgsProps) => (
  <>
    <VersionBadge>{versionAvailableFrom}</VersionBadge> から利用可能
    <h2>
